...
Editors and assistants can still use **[MCP](/mcp)** to wrap tools, but **authoring** the WASM application and owning its release process belongs in this repo and workflow. Start from the [Quickstart](/quickstart) integration map, then the **[QUICKSTART-AGENT](https://github.com/morpheum-labs/mwvm/blob/main/QUICKSTART-AGENT.md)** and **README** in [morpheum-labs/mwvm](https://github.com/morpheum-labs/mwvm).
